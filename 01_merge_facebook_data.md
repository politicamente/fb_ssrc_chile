...
\#\#Merge Datasets (candidate level) Now we are going to group the data
at the candidate level for future analysis. This dataset only includes
the candidates from the districts 10, 11 and 13, which are the focus of
this paper.
